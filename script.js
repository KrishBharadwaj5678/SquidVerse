...
scaleSlider.addEventListener("input", () => {
  modelViewer.setAttribute(
    "scale",
    `${scaleSlider.value} ${scaleSlider.value} ${scaleSlider.value}`,
  );
...
cameraSlider.addEventListener("input", () => {
  modelViewer.setAttribute(
    "camera-orbit",
    `180deg auto ${cameraSlider.value}m`,
  );
